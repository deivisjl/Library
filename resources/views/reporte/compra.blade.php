...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h2><span class="badge badge-libreria">Reporte de compras <small>Reportes</small></span></h2>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/">Inicio</a></li>
              <li class="breadcrumb-item active">Reporte de compra</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
  ...
  obtener_compra = function(){
      ...
      else
      {
          var data = {desde:desde,hasta:hasta};
           ...
           $.ajax({
                type:'GET',
                url:'/reporte-pdf-compras-obtener/show',
                data:data,                    
                xhrFields: {
                    responseType: 'blob'
                },
